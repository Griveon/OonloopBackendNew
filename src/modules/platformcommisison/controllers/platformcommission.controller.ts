...
import { PlatformCommissionService } from "../services/platformcommission.service.js";
import { ResponseUtil } from "../../../utils/response.util.js";

export class PlatformCommissionController {
    private service: PlatformCommissionService;

    constructor() {
        this.service = new PlatformCommissionService();
    }
    ...
    create = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.service.createCommission(data);

            return res
                .status(201)
                .json(ResponseUtil.created("Commission created", result));
        } catch (error: any) {
            return res
                .status(400)
    ...
    getById = async (req: Request, res: Response) => {
        try {
            ...
            if (!id) {
                return res
                    .status(400)
                    .json(ResponseUtil.badRequest("Commission ID is required"));
            }
