...
import { RibbonService } from "../services/ribbon.service.js";
import { ResponseUtil } from "../../../utils/response.util.js";

export class RibbonController {
    private service: RibbonService;

    constructor() {
        this.service = new RibbonService();
    }
    ...
    create = async (req: Request, res: Response) => {
        try {
            ...
            return res
                .status(201)
                .json(ResponseUtil.created("Ribbon created", result));
        } catch (error: any) {
            return res
                .status(400)
    ...
    createBulk = async (req: Request, res: Response) => {
        try {
            ...
            return res
                .status(201)
                .json(ResponseUtil.created("Ribbons created successfully", result));
        } catch (error: any) {
            return res
                .status(400)
                .json(ResponseUtil.badRequest(error.message));
