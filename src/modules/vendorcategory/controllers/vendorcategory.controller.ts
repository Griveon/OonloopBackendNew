...
import { VendorCategoryService } from "../services/vendorcategory.service.js";
import { ResponseUtil } from "../../../utils/response.util.js";

export class VendorCategoryController {
    private service: VendorCategoryService;

    constructor() {
        this.service = new VendorCategoryService();
    }
    ...
    create = async (req: Request, res: Response) => {
        try {
            ...
            return res
                .status(201)
                .json(ResponseUtil.created("Category created", result));
        } catch (error: any) {
            return res
                .status(400)
